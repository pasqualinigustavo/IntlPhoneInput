 ...
 * Found on github at https://github.com/elye/demo_materiallogin
 */
public class CustomTextInputLayout extends TextInputLayout {
    ...
    public CustomTextInputLayout(Context _context, AttributeSet _attrs) {
        ...
        try {
            mHelperTextColor = a.getColorStateList(R.styleable.CustomTextInputLayout_ctil_helperTextColor);
            mHelperText = a.getText(R.styleable.CustomTextInputLayout_ctil_helperText);
        } finally {
            a.recycle();
        }
    }
